...
//create admin
 const createAdmin = async (req, res) => {
    const { name, email, password, role, title, addressline, town, phone } = req.body;
...
// Update user data (name, email, role, status)
const updateUserData = async (req, res) => {
  ...
  try {
    ...
    const [checkResult] = await connection.promise().execute(
    ...
    const [updateResult] = await connection.promise().execute(updateSql, updateValues);
